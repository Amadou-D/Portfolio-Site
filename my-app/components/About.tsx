...
const About: React.FC<AboutProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full flex items-center justify-center z-50 p-4 overflow-y-auto">
      ...
      <div className="relative z-10 max-w-3xl mx-auto p-8 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg text-gray-800 text-left mt-24 overflow-y-auto max-h-full bg-enhanced font-press-start">
        <button
